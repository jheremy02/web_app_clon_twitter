...
function handleSelectedFile(event) {
    ...
    return <div classNameName="bg-yellow-400 h-screen overflow-hidden flex items-center justify-center">
    <div classNameName="bg-white lg:w-5/12 md:6/12 w-10/12 shadow-3xl">
      <div classNameName="bg-gray-800 absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-full p-4 md:p-8">
